    ...
    <script>
        $(document).ready(function() {
            ...
            function userLoad() {
                ...
                $.post('http://localhost/social-connect/core/ajax/mesgFetch.php', {
                    loadUserid: userid
                }, function(data) {
            ...
            setTimeout(function() {
                $(document).on('keyup', '.emojionearea .emojionearea-editor', function(e) {
                    if (e.keyCode == 13) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "http://localhost/social-connect/core/ajax/message.php",
                            data: {
            ...
            function loadMessage() {
                ...
                $.post('http://localhost/social-connect/core/ajax/message.php', {
                    dataCount: otheridd,
                    profileid: useridd
                }, function(data) {
