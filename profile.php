        ...
        $(function() {
            ...
            $(document).on('keyup', '.emojionearea-editor', function() {
                ...
                if (regex_text != null) {
                    ...
                    $.post('http://localhost/social-connect/core/ajax/hashtag_mention.php', {
            ...
            $(document).on('click', '.block-show', function() {
                ...
                $.post('http://localhost/social-connect/core/ajax/block.php', {
                    profileid: profileid,
                    userid: userid
                }, function(data) {
                    location.reload();
            ...
            var BASE_URL = "http://localhost/social-connect/";

            function notificationUpdate(userid) {
                $.post('http://localhost/social-connect/core/ajax/notify.php', {
            ...
            $(document).on('change', '#profile-upload', function() {
                ...
                if (name != '') {
                    $.post('http://localhost/social-connect/core/ajax/profilePhoto.php', {
                        imgName: imgName,
                        userid: userid
                    }, function(data) {
                        //                            $('#adv_dem').html(/data);
                    ...
                    $.ajax({
                        url: 'http://localhost/social-connect/core/ajax/profilePhoto.php',
                        cache: false,
                        contentType: false,
                        processData: false,
                        data: form_data,
            ...
            $('#cover-upload').on('change', function() {
                ...
                if (name != '') {
                    $.post('http://localhost/social-connect/core/ajax/profile.php', {
                        imgName: imgName,
                        userid: userid
                    }, function(data) {
                        //                            alert(data);
                ...
                $.ajax({
                    url: 'http://localhost/social-connect/core/ajax/profile.php',
                    cache: false,
                    contentType: false,
                    processData: false,
                    data: form_data,
            ...
            $('.status-share-button').on('click', function() {
                ...
                if (files.length != 0) {
                    ...
                    if (error_images == '') {
                        $.ajax({
                            url: 'http://localhost/social-connect/core/ajax/uploadPostImage.php',
                            method: "POST",
                            data: formData,
                            contentType: false,
                            cache: false,
                ...
                if (stIm == '') {
                    $.post('http://localhost/social-connect/core/ajax/postSubmit.php', {
            ...
            $(document).on('click', '.postImage', function() {
                ...
                $.post('http://localhost/social-connect/core/ajax/imgFetchShow.php', {
                    fetchImgInfo: userid,
                    postid: postid,
                    imageSrc: imageSrc
                }, function(data) {
                    ...
                    $('.comment-submit').keyup(function(e) {
                        if (e.keyCode == 13) {
                            ...
                            if (comment == '') {
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: "http://localhost/social-connect/core/ajax/comment.php",
                                    data: {
                                        comment: comment,
                                        userid: userid,
                                        postid: postid,
            ...
            $(document).on('click', '.edit-post-save', function() {
                ...
                $.post('http://localhost/social-connect/core/ajax/editPost.php', {
            ...
            function mainReactSubmit(typeR, postId, userId, nf_3) {
                var profileid = p_id;
                $.post('http://localhost/social-connect/core/ajax/react.php', {
                    reactType: typeR,
                    postId: postId,
                    userId: userId,
                    profileid: profileid
            ...
            function comReactSubmit(typeR, postid, userid, commentID, com_nf_3) {
                var profileid = p_id;
                $.post('http://localhost/social-connect/core/ajax/commentReact.php', {
                        commentid: commentID,
                        reactType: typeR,
                        postid: postid,
                        userid: userid,
            ...
            $(document).on('click', '.edit-com-save', function() {
                ...
                var editedTextVal = $(editedText).val();
                $.post('http://localhost/social-connect/core/ajax/editComment.php', {
                    postid: postid,
                    userid: userid,
                    editedTextVal: editedTextVal,
                    commentid: commentid
                ...
                $('input.reply-input-style.reply-submit').keyup(function(e) {
                    if (e.keyCode == 13) {
                        ...
                        if (comment == '') {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "http://localhost/social-connect/core/ajax/reply.php",
                                data: {
            ...
            function replyReactSubmit(typeR, postid, userid, commentID, commentparentid, com_nf_3) {
                var profileid = p_id;
                $.post('http://localhost/social-connect/core/ajax/replyReact.php', {
                    commentid: commentID,
                    reactType: typeR,
                    postid: postid,
                    userid: userid,
            ...
            $(document).on('click', '.edit-reply-save', function() {
                ...
                $.post('http://localhost/social-connect/core/ajax/editReply.php', {
                    postid: postid,
                    userid: userid,
                    editedTextVal: editedTextVal,
                    commentid: commentid,
            ...
            $(document).on('click', '.post-Share', function() {
                ...
                $.post('http://localhost/social-connect/core/ajax/share.php', {
                    shareText: shareText,
                    profileid: profileid,
                    postid: postid,
                    userid: userid
            ...
            $(document).on('click', '.share-container', function() {
                ...
                window.location.href = "http://localhost/social-connect/profile.php?username=" + userLink + "";
            })
            ...
            $(document).on('click', '.shared-edit-post-save', function() {
                ...
                var editedTextVal = $(editedText).val();
                $.post('http://localhost/social-connect/core/ajax/sharedEditPost.php', {
                    sharedPostid: postid,
                    userid: userid,
                    editedTextVal: editedTextVal
                }, function(data) {
            ...
            $(document).on('keyup', 'input#main-search', function() {
                ...
                if (searchText == '') {
                    ...
                    $.post('http://localhost/social-connect/core/ajax/search.php', {
            ...
            $(document).on('click', '.profile-add-friend', function() {
                ...
                $.post('http://localhost/social-connect/core/ajax/request.php', {
                    request: profileid,
                    userid: userid
                }, function(data) {
